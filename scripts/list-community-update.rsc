:do {
    ...
    :local maxretry 3;
    :local delay 120s;
    :local url "https://community.antifilter.download/list/community.lst";
    :local listname "list-community";
    ...
    :for retry from=1 to=$maxretry step=1 do={
        ...
        :if (retryflag) do={
            ...
            :do {
                /ip firewall address-list add list=($listname."-updated") address=community.antifilter.download comment="community.antifilter.download";
            } on-error={};
